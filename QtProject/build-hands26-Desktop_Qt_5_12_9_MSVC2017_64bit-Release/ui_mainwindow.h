...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        MainWindow->resize(1451, 798);
        centralwidget = new QWidget(MainWindow);
        centralwidget->setObjectName(QString::fromUtf8("centralwidget"));
        ogl_cam = new QOpenGLWidget(centralwidget);
        ogl_cam->setObjectName(QString::fromUtf8("ogl_cam"));
        ogl_cam->setGeometry(QRect(20, 10, 960, 720));
        pb_opencam = new QPushButton(centralwidget);
        pb_opencam->setObjectName(QString::fromUtf8("pb_opencam"));
        pb_opencam->setGeometry(QRect(20, 730, 81, 31));
        label = new QLabel(centralwidget);
        label->setObjectName(QString::fromUtf8("label"));
        label->setGeometry(QRect(990, 10, 461, 281));
        label->setStyleSheet(QString::fromUtf8("background-color: rgb(0, 85, 0);"));
        label->setPixmap(QPixmap(QString::fromUtf8(":/new/img/myHands26.jpg")));
        MainWindow->setCentralWidget(centralwidget);
        menubar = new QMenuBar(MainWindow);
        menubar->setObjectName(QString::fromUtf8("menubar"));
        menubar->setGeometry(QRect(0, 0, 1451, 23));
